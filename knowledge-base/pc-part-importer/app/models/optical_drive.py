...
class OpticalDrive(Base):
    ...
    part_numbers = relationship("OpticalDrivePartNumber", back_populates="optical_drive", cascade="all, delete-orphan")
...
class OpticalDrivePartNumber(Base):
    ...
    optical_drive = relationship("OpticalDrive", back_populates="part_numbers")